...
public:
	...
	void Projection(Vector3* outPosition, Vector3 source, Matrix& W, Matrix& V, Matrix& P);
	void UnProjection(Vector3* outPosition, Vector3 source, Matrix& W, Matrix& V, Matrix& P);
