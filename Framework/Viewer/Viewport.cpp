...
void Viewport::Projection(Vector3 * outPosition, Vector3 source, Matrix & W, Matrix & V, Matrix & P)
{
...
void Viewport::UnProjection(Vector3 * outPosition, Vector3 source, Matrix & W, Matrix & V, Matrix & P)
{
	Vector3 position = source;
